...
\\
\solution
\lstinputlisting{Assignment 1/Codes/cancel_noise.py}
%\begin{figure}[h]
%\centering
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{Assignment 1/Figs/xnyn.png}
\end{center}
\captionof{figure}{}
\label{fig:xnyn}	
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{Assignment 1/Figs/dtft}
